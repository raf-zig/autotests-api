...
class CourseServiceServicer(course_service_pb2_grpc.CourseServiceServicer):
    ...
    def GetCourse(self, request, context):
        ...
        return course_service_pb2.GetCourseResponse(course_id=f'course_id: "{request.course_id}"', title='title: "Автотесты API"', description='description: "Будем изучать написание API автотестов"')
